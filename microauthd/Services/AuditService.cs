...
public static class AuditService
{
    ...
    /// <summary>
    /// Retrieves the total number of audit log entries.
    /// </summary>
    /// <returns>The total count of audit log entries stored in the system.</returns>
    public static int GetAuditLogCount() => AuditStore.GetAuditLogCount();
}
