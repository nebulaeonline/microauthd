...
public static class ApiResultExtensions
{
    ...
    public static JsonTypeInfo<T> GetJsonTypeInfo<T>()
    {
        object? resolved = typeof(T) switch
        {
            ...
            var t when t == typeof(ExternalIdpProviderDto) =>
                MicroauthdJsonContext.Default.ExternalIdpProviderDto,

            var t when t == typeof(List<ExternalIdpProviderDto>) =>
                MicroauthdJsonContext.Default.ListExternalIdpProviderDto,
